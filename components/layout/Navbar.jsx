...
export default function Navbar() {
  ...
  // Navegación a secciones de la home.
  // Confiamos en `scroll-behavior: smooth` global (globals.css) +
  // `scroll-margin-top` en las secciones, así no necesitamos scrollIntoView.
  const handleSectionClick = (e, sectionId) => {
    setIsMobileMenuOpen(false)
    setOpenDropdown(null)

    if (isInAdminPages) {
      // En admin no hay anchors locales; navegar a la home con hash.
      e.preventDefault()
      router.push(`/#${sectionId}`)
    }
    // Si ya estamos en home, dejamos que el href="#xxx" haga el trabajo.
  }
