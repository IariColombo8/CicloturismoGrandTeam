...
export default function HeroSection() {
  ...
  // El smooth scroll lo maneja `scroll-behavior: smooth` en globals.css.
  const handleScrollToSection = (e, sectionId) => {
    // No prevent default: dejamos que el href="#id" navegue nativamente.
  }
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0" aria-hidden="true">
        ...
        {/* Blobs solo desktop: en móvil cuestan demasiado al compositor. */}
        <div className="hidden lg:block absolute top-0 right-0 w-1/3 h-1/3 bg-amber-500/5 blur-3xl rounded-full" />
        <div className="hidden lg:block absolute bottom-0 left-0 w-1/2 h-1/2 bg-amber-400/3 blur-3xl rounded-full" />
      </div>
              ...
              return (
                ...
                >
                  <div className="relative">
                    ...
                    <p className="text-[11px] sm:text-xs text-slate-400 uppercase tracking-wider">{card.label}</p>
