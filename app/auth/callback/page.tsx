              ...
              if (event === "SIGNED_IN" && newSession?.user) {
                ...
                try {
                  await supabase.rpc("link_auth_user", {
                    ...
                    p_auth_user_id: newSession.user.id,
                    p_display_name: newSession.user.user_metadata?.full_name || null,
                    p_photo_url: newSession.user.user_metadata?.avatar_url || null,
                    p_login_method: newSession.user.app_metadata?.provider === "google" ? "google" : "email",
                  })
                } catch (rpcError) {
                  console.error("Error en link_auth_user:", rpcError)
                }
