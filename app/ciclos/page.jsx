...
import { MapPin, Calendar, Clock, Mountain, Bike, ChevronRight, Search, Filter } from "lucide-react"
...
export default function CiclosPage() {
  ...
  const ciclosFiltrados = ciclos.filter((ciclo) => {
    const coincideBusqueda =
      ...
      ciclo.localidad?.toLowerCase().includes(busqueda.toLowerCase())
    const coincideFiltro = filtro === "todos" || ciclo.dificultad === filtro
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-black via-zinc-900 to-black">
      ...
      {/* Hero */}
      <section className="pt-24 pb-10 sm:pt-32 sm:pb-16 relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
          <div className="absolute top-20 right-10 w-96 h-96 bg-yellow-500/5 rounded-full blur-3xl" />
          <div className="absolute bottom-10 left-10 w-80 h-80 bg-amber-400/5 rounded-full blur-3xl" />
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white mb-3 sm:mb-4">
              Descubrí los <span className="gradient-text">Ciclos</span>
            </h1>
            <p className="text-base sm:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed px-2">
              Explorá las mejores rutas ciclísticas de la provincia. Desde paseos recreativos hasta desafíos extremos.
            </p>
          </div>

          {/* Filtros */}
          <div className="max-w-4xl mx-auto flex flex-col gap-3 sm:gap-4 mb-8 sm:mb-12">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-zinc-900 border border-zinc-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-yellow-400/50 transition-colors text-sm sm:text-base"
              />
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {loading ? (
            ...
            <div className="text-center py-16">
              <Bike className="w-12 h-12 sm:w-16 sm:h-16 text-gray-600 mx-auto mb-4" />
              <p className="text-gray-400 text-base sm:text-lg">
                {busqueda || filtro !== "todos"
                  ? "No se encontraron ciclos con esos filtros."
                  : "Aún no hay ciclos publicados. ¡Pronto habrá novedades!"}
              </p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <div className="flex items-center gap-2 text-gray-400 text-sm mb-3 sm:mb-4">
                      ...
                      <span className="truncate">{ciclo.localidad || "Sin especificar"}</span>
                    </div>

                    {/* Descripción */}
                    {ciclo.descripcion && (
                      <p className="text-gray-400 text-sm mb-4 sm:mb-6 line-clamp-2 sm:line-clamp-3">
                        {ciclo.descripcion}
                      </p>
                    )}
